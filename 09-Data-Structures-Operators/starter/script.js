...
console.log('Dylan Katsch'.split(' '));

const [firstName, lastName] = 'Dylan Katsch'.split(' ');
...
console.log(maskGreditCard(43378738));
console.log(maskGreditCard(4337846386464738));
console.log(maskGreditCard('727398749273992349'));
